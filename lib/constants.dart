...
List<FoodItems> foodItemList=[
  FoodItems(imageUrl: "https://previews.123rf.com/images/firstblood/firstblood1506/firstblood150600075/40973395-transparent-glass-bowl-with-greek-salad-isolated-on-white-background-top-view.jpg",
      name: "Healthy"),
  FoodItems(
      name: "Pizza",
      imageUrl:
...
class Restaurants{
  ...
  int id;
  Restaurants({required this.imageUrl,required this.title,required this.locations,required this.rating, required this.description,
